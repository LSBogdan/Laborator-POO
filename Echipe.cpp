...
FCA::FCA(std::string nume, int an_infiintare, int campionat, int cupa_romaniei, int supercupa_romaniei) : Participanti(nume, an_infiintare, campionat, cupa_romaniei, supercupa_romaniei)
{
